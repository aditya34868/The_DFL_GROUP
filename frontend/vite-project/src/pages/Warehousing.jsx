        ...
        <div className="relative w-full rounded-2xl bg-white p-4 text-slate-700 shadow-md border border-slate-200">
          <div className="flex items-center justify-between text-xs font-semibold text-slate-500 mb-2 px-2">
            ...
            <span className="font-bold text-slate-600">
              Real-Time Inventory Node: Active
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-12 lg:items-center relative z-10">
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-sm md:text-base leading-relaxed text-slate-600 font-medium">
                Optimize your supply chain with The DFL Group’s all-encompassing
                inventory management solutions. In our pursuit of a
                digital-integrated supply chain, we offer global online access
                to warehousing services with complete transparency and real-time
                stock updates.
              </p>
                ...
                <div className="mt-4 flex items-center justify-between px-2 pb-1">
                  <div>
                    ...
                    <span className="text-[11px] text-slate-500 font-medium">
                      24/7 Security & Inventory Monitoring
                    </span>
                  </div>
        ...
        <section className="space-y-10">
          <div className="text-center max-w-2xl mx-auto space-y-3">
            ...
            <p className="text-sm text-slate-600 font-medium">
              Smart warehousing solutions rigorously tested and optimized by
              professionals for secure management.
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {warehouseWhyChooseUs.map((item, idx) => {
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center rounded-3xl bg-white border border-slate-200 p-6 sm:p-10 md:p-12 shadow-sm">
          <div className="lg:col-span-5 space-y-5">
            ...
            <p className="text-sm text-slate-600 font-medium leading-relaxed">
              The DFL Group’s commitment to providing dependable warehousing
              solutions strengthens the overall supply chain experience through
              modern facilities and seamless connectivity.
            </p>
            <div className="pt-2">
              <Link
                to="/contact"
                ...
                >
                  <div className="flex items-center gap-2.5">
                    <div className="p-2 rounded-lg bg-white border border-slate-200 shadow-sm">
                      <IconComponent className="h-5 w-5 text-[#E66E19]" />
                    </div>
        ...
        <section className="rounded-3xl bg-orange-50 border border-orange-200 text-slate-800 p-8 sm:p-12 flex flex-col sm:flex-row items-center justify-between gap-6 shadow-md">
          <div>
            ...
            <p className="text-xs sm:text-sm text-slate-600 mt-1 font-medium">
              Ready to make your inventory smarter, not just bigger? Let us help
              transform your warehousing operations.
            </p>
          </div>
          <button
            type="button"
